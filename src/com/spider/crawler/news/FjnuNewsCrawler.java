 ...
 */
public class FjnuNewsCrawler extends DeepCrawler {
	public static final Logger LOG = LoggerFactory.getLogger(FjnuNewsCrawler.class);
	private SpiderConfig spiderConfig;

	public FjnuNewsCrawler(String crawlPath) {
		super(crawlPath);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		FjnuNewsCrawler nc = new FjnuNewsCrawler("log/nc");
